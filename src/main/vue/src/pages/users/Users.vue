      ...
      <v-layout align-top justify-center>
        <v-flex xs12 sm12 md12>
          ...
          <v-data-table :headers="[
            ...
            {text: 'Status', value: 'statusActive'},
            ...
            <template slot="items" slot-scope="props">
              ...
              <td class="text-xs-left" v-if="props.item.statusActive == 1">
                <v-btn outline color="success" small>Ativo</v-btn>
              </td>
              <td class="text-xs-left" v-if="props.item.statusActive == 0">
                <v-btn outline color="error" small>Inativo</v-btn>
              </td>
  ...
  export default {
    ...
    methods: {
      ...
      list() {
        ...
        axios.get(CONFIG.URL_API + 'users/' + this.pagination.rowsPerPage + "/" + (this.page - 1), { headers: headers }).then(response => {
          ...
          console.log(e);
          this.load = false;
            this.error = "Ocorreu um erro ao listar os usuários";
          this.snackbar = true;
          console.log(e);
        });
      },
